    ...
    <div className="space-y-6">
      ...
      <section className="rounded-2xl border border-border bg-surface p-6">
        <div className="mb-4 flex items-center justify-between">
          <h2 className="text-base font-semibold text-text-default">All Forms</h2>
          <Link href="/admin/forms" className="text-sm font-semibold text-primary hover:text-primary-hover">
            Open forms page
          </Link>
        </div>
          ...
          {chartData.forms.map((form: { formId: number; title: string; isActive: boolean }) => (
            <article key={form.formId} className="rounded-2xl border border-border bg-surface-soft p-4">
              ...
              <div className="mt-2 flex items-center justify-between">
                ...
                <Link href={`/admin/forms/${form.formId}`} className="text-xs font-semibold text-text-default hover:text-primary">
                  Edit
                </Link>
              </div>
            </article>
